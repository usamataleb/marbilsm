...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.TaskInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).task.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.TaskInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).task.deleteMany(input as any))),
