...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.InvoiceInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).invoice.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.InvoiceInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).invoice.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.InvoiceInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).invoice.findFirst(input as any))),

        findMany: procedure.input($Schema.InvoiceInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).invoice.findMany(input as any))),
